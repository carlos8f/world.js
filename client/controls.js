define(['camera', 'ship'], function(camera, getShip) {
  var controls = new ImpulseControls();
  getShip(function(ship) {
    ship.mesh.useQuaternion = true;
    controls.object = ship.mesh;
  });
  return controls;
});

function ImpulseControls(object, domElement) {
  this.object = object;
